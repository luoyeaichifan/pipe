...
type User struct {
	...
	Password          string `gorm:"size:255" json:"password"` // https://github.com/luoyeaichifan/pipe/issues/130
	...
	GithubId          string `gorm:"255" json:"githubId"` // 支持 GitHub 登录 https://github.com/luoyeaichifan/pipe/issues/150
}
